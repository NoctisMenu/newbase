...
namespace CS2Dumper.Schemas {
    ...
    public static class ParticlesDll {
        ...
        public static class C_OP_RenderVolumetricEmitter {
            public const nint m_strSmokeType = 0x228; // CUtlString
            ...
            public const nint m_flFuel = 0x1400; // CPerParticleFloatInput
            public const nint m_flDust = 0x1570; // CPerParticleFloatInput
            public const nint m_flLifespan = 0x16E0; // CPerParticleFloatInput
            public const nint m_flMagnitude = 0x1850; // CPerParticleFloatInput
            public const nint m_flKillRadius = 0x19C0; // CPerParticleFloatInput
            public const nint m_flFalloff = 0x1B30; // CPerParticleFloatInput
        }
        // Parent: None
        // Field count: 8
        //
        ...
        public static class C_OP_InheritFromParentParticlesV2 {
            ...
            public const nint m_bRandomDistribution = 0x4C0; // bool
            public const nint m_bReverse = 0x4C1; // bool
        ...
        public static class C_OP_RenderOmni2Light {
            ...
            public const nint m_bFog = 0xBD1; // bool
            public const nint m_flFogScale = 0xBD8; // CPerParticleFloatInput
            public const nint m_flLuminaireRadius = 0xD48; // CPerParticleFloatInput
            public const nint m_flSkirt = 0xEB8; // CPerParticleFloatInput
            public const nint m_flRange = 0x1028; // CPerParticleFloatInput
            public const nint m_flInnerConeAngle = 0x1198; // CPerParticleFloatInput
            public const nint m_flOuterConeAngle = 0x1308; // CPerParticleFloatInput
            public const nint m_hLightCookie = 0x1478; // CStrongHandle<InfoForResourceTypeCTextureBase>
            public const nint m_bSphericalCookie = 0x1480; // bool
        }
        // Parent: None
        // Field count: 5
        //
        ...
        public static class C_OP_RenderStandardLight {
            ...
            public const nint m_flTheta = 0xA68; // CParticleCollectionFloatInput
            public const nint m_flPhi = 0xBD8; // CParticleCollectionFloatInput
            public const nint m_flRadiusMultiplier = 0xD48; // CParticleCollectionFloatInput
            public const nint m_nAttenuationStyle = 0xEB8; // StandardLightingAttenuationStyle_t
            public const nint m_flFalloffLinearity = 0xEC0; // CParticleCollectionFloatInput
            public const nint m_flFiftyPercentFalloff = 0x1030; // CParticleCollectionFloatInput
            public const nint m_flZeroPercentFalloff = 0x11A0; // CParticleCollectionFloatInput
            public const nint m_bRenderDiffuse = 0x1310; // bool
            public const nint m_bRenderSpecular = 0x1311; // bool
            public const nint m_lightCookie = 0x1318; // CUtlString
            public const nint m_nPriority = 0x1320; // int32
            public const nint m_nFogLightingMode = 0x1324; // ParticleLightFogLightingMode_t
            public const nint m_flFogContribution = 0x1328; // CParticleCollectionRendererFloatInput
            public const nint m_nCapsuleLightBehavior = 0x1498; // ParticleLightBehaviorChoiceList_t
            public const nint m_flCapsuleLength = 0x149C; // float32
            public const nint m_bReverseOrder = 0x14A0; // bool
            public const nint m_bClosedLoop = 0x14A1; // bool
            public const nint m_nPrevPntSource = 0x14A4; // ParticleAttributeIndex_t
            public const nint m_flMaxLength = 0x14A8; // float32
            public const nint m_flMinLength = 0x14AC; // float32
            public const nint m_bIgnoreDT = 0x14B0; // bool
            public const nint m_flConstrainRadiusToLengthRatio = 0x14B4; // float32
            public const nint m_flLengthScale = 0x14B8; // float32
            public const nint m_flLengthFadeInTime = 0x14BC; // float32
        }
        // Parent: None
        // Field count: 15
        //
        ...
        public static class C_OP_RenderLightBeam {
            ...
            public const nint m_flBrightnessLumensPerMeter = 0x8E8; // CParticleCollectionFloatInput
            public const nint m_bCastShadows = 0xA58; // bool
            public const nint m_flSkirt = 0xA60; // CParticleCollectionFloatInput
            public const nint m_flRange = 0xBD0; // CParticleCollectionFloatInput
            public const nint m_flThickness = 0xD40; // CParticleCollectionFloatInput
        }
        // Parent: None
        // Field count: 6
        //
        ...
        public static class C_OP_RenderModels {
            ...
            public const nint m_ClothEffectName = 0x1A19; // char[64]
