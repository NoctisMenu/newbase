    ...
    namespace schemas {
        ...
        namespace particles_dll {
            ...
            namespace C_OP_RenderVolumetricEmitter {
                constexpr std::ptrdiff_t m_strSmokeType = 0x228; // CUtlString
                ...
                constexpr std::ptrdiff_t m_flFuel = 0x1400; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flDust = 0x1570; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLifespan = 0x16E0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flMagnitude = 0x1850; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flKillRadius = 0x19C0; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flFalloff = 0x1B30; // CPerParticleFloatInput
            }
            // Parent: None
            // Field count: 8
            //
            ...
            namespace C_OP_InheritFromParentParticlesV2 {
                ...
                constexpr std::ptrdiff_t m_bRandomDistribution = 0x4C0; // bool
                constexpr std::ptrdiff_t m_bReverse = 0x4C1; // bool
            ...
            namespace C_OP_RenderOmni2Light {
                ...
                constexpr std::ptrdiff_t m_bFog = 0xBD1; // bool
                constexpr std::ptrdiff_t m_flFogScale = 0xBD8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flLuminaireRadius = 0xD48; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flSkirt = 0xEB8; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flRange = 0x1028; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flInnerConeAngle = 0x1198; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_flOuterConeAngle = 0x1308; // CPerParticleFloatInput
                constexpr std::ptrdiff_t m_hLightCookie = 0x1478; // CStrongHandle<InfoForResourceTypeCTextureBase>
                constexpr std::ptrdiff_t m_bSphericalCookie = 0x1480; // bool
            }
            // Parent: None
            // Field count: 5
            //
            ...
            namespace C_OP_RenderStandardLight {
                ...
                constexpr std::ptrdiff_t m_flTheta = 0xA68; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flPhi = 0xBD8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRadiusMultiplier = 0xD48; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_nAttenuationStyle = 0xEB8; // StandardLightingAttenuationStyle_t
                constexpr std::ptrdiff_t m_flFalloffLinearity = 0xEC0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flFiftyPercentFalloff = 0x1030; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flZeroPercentFalloff = 0x11A0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bRenderDiffuse = 0x1310; // bool
                constexpr std::ptrdiff_t m_bRenderSpecular = 0x1311; // bool
                constexpr std::ptrdiff_t m_lightCookie = 0x1318; // CUtlString
                constexpr std::ptrdiff_t m_nPriority = 0x1320; // int32
                constexpr std::ptrdiff_t m_nFogLightingMode = 0x1324; // ParticleLightFogLightingMode_t
                constexpr std::ptrdiff_t m_flFogContribution = 0x1328; // CParticleCollectionRendererFloatInput
                constexpr std::ptrdiff_t m_nCapsuleLightBehavior = 0x1498; // ParticleLightBehaviorChoiceList_t
                constexpr std::ptrdiff_t m_flCapsuleLength = 0x149C; // float32
                constexpr std::ptrdiff_t m_bReverseOrder = 0x14A0; // bool
                constexpr std::ptrdiff_t m_bClosedLoop = 0x14A1; // bool
                constexpr std::ptrdiff_t m_nPrevPntSource = 0x14A4; // ParticleAttributeIndex_t
                constexpr std::ptrdiff_t m_flMaxLength = 0x14A8; // float32
                constexpr std::ptrdiff_t m_flMinLength = 0x14AC; // float32
                constexpr std::ptrdiff_t m_bIgnoreDT = 0x14B0; // bool
                constexpr std::ptrdiff_t m_flConstrainRadiusToLengthRatio = 0x14B4; // float32
                constexpr std::ptrdiff_t m_flLengthScale = 0x14B8; // float32
                constexpr std::ptrdiff_t m_flLengthFadeInTime = 0x14BC; // float32
            }
            // Parent: None
            // Field count: 15
            //
            ...
            namespace C_OP_RenderLightBeam {
                ...
                constexpr std::ptrdiff_t m_flBrightnessLumensPerMeter = 0x8E8; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_bCastShadows = 0xA58; // bool
                constexpr std::ptrdiff_t m_flSkirt = 0xA60; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flRange = 0xBD0; // CParticleCollectionFloatInput
                constexpr std::ptrdiff_t m_flThickness = 0xD40; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Field count: 6
            //
            ...
            namespace C_OP_RenderModels {
                ...
                constexpr std::ptrdiff_t m_ClothEffectName = 0x1A19; // char[64]
