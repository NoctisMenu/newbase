    ...
    pub mod schemas {
        ...
        pub mod particles_dll {
            ...
            pub mod C_OP_RenderVolumetricEmitter {
                pub const m_strSmokeType: usize = 0x228; // CUtlString
                ...
                pub const m_flFuel: usize = 0x1400; // CPerParticleFloatInput
                pub const m_flDust: usize = 0x1570; // CPerParticleFloatInput
                pub const m_flLifespan: usize = 0x16E0; // CPerParticleFloatInput
                pub const m_flMagnitude: usize = 0x1850; // CPerParticleFloatInput
                pub const m_flKillRadius: usize = 0x19C0; // CPerParticleFloatInput
                pub const m_flFalloff: usize = 0x1B30; // CPerParticleFloatInput
            }
            // Parent: None
            // Field count: 8
            //
            ...
            pub mod C_OP_InheritFromParentParticlesV2 {
                ...
                pub const m_bRandomDistribution: usize = 0x4C0; // bool
                pub const m_bReverse: usize = 0x4C1; // bool
            ...
            pub mod C_OP_RenderOmni2Light {
                ...
                pub const m_bFog: usize = 0xBD1; // bool
                pub const m_flFogScale: usize = 0xBD8; // CPerParticleFloatInput
                pub const m_flLuminaireRadius: usize = 0xD48; // CPerParticleFloatInput
                pub const m_flSkirt: usize = 0xEB8; // CPerParticleFloatInput
                pub const m_flRange: usize = 0x1028; // CPerParticleFloatInput
                pub const m_flInnerConeAngle: usize = 0x1198; // CPerParticleFloatInput
                pub const m_flOuterConeAngle: usize = 0x1308; // CPerParticleFloatInput
                pub const m_hLightCookie: usize = 0x1478; // CStrongHandle<InfoForResourceTypeCTextureBase>
                pub const m_bSphericalCookie: usize = 0x1480; // bool
            }
            // Parent: None
            // Field count: 5
            //
            ...
            pub mod C_OP_RenderStandardLight {
                ...
                pub const m_flTheta: usize = 0xA68; // CParticleCollectionFloatInput
                pub const m_flPhi: usize = 0xBD8; // CParticleCollectionFloatInput
                pub const m_flRadiusMultiplier: usize = 0xD48; // CParticleCollectionFloatInput
                pub const m_nAttenuationStyle: usize = 0xEB8; // StandardLightingAttenuationStyle_t
                pub const m_flFalloffLinearity: usize = 0xEC0; // CParticleCollectionFloatInput
                pub const m_flFiftyPercentFalloff: usize = 0x1030; // CParticleCollectionFloatInput
                pub const m_flZeroPercentFalloff: usize = 0x11A0; // CParticleCollectionFloatInput
                pub const m_bRenderDiffuse: usize = 0x1310; // bool
                pub const m_bRenderSpecular: usize = 0x1311; // bool
                pub const m_lightCookie: usize = 0x1318; // CUtlString
                pub const m_nPriority: usize = 0x1320; // int32
                pub const m_nFogLightingMode: usize = 0x1324; // ParticleLightFogLightingMode_t
                pub const m_flFogContribution: usize = 0x1328; // CParticleCollectionRendererFloatInput
                pub const m_nCapsuleLightBehavior: usize = 0x1498; // ParticleLightBehaviorChoiceList_t
                pub const m_flCapsuleLength: usize = 0x149C; // float32
                pub const m_bReverseOrder: usize = 0x14A0; // bool
                pub const m_bClosedLoop: usize = 0x14A1; // bool
                pub const m_nPrevPntSource: usize = 0x14A4; // ParticleAttributeIndex_t
                pub const m_flMaxLength: usize = 0x14A8; // float32
                pub const m_flMinLength: usize = 0x14AC; // float32
                pub const m_bIgnoreDT: usize = 0x14B0; // bool
                pub const m_flConstrainRadiusToLengthRatio: usize = 0x14B4; // float32
                pub const m_flLengthScale: usize = 0x14B8; // float32
                pub const m_flLengthFadeInTime: usize = 0x14BC; // float32
            }
            // Parent: None
            // Field count: 15
            //
            ...
            pub mod C_OP_RenderLightBeam {
                ...
                pub const m_flBrightnessLumensPerMeter: usize = 0x8E8; // CParticleCollectionFloatInput
                pub const m_bCastShadows: usize = 0xA58; // bool
                pub const m_flSkirt: usize = 0xA60; // CParticleCollectionFloatInput
                pub const m_flRange: usize = 0xBD0; // CParticleCollectionFloatInput
                pub const m_flThickness: usize = 0xD40; // CParticleCollectionFloatInput
            }
            // Parent: None
            // Field count: 6
            //
            ...
            pub mod C_OP_RenderModels {
                ...
                pub const m_ClothEffectName: usize = 0x1A19; // char[64]
