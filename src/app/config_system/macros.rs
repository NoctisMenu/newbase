...
macro_rules! config {
    ($app:expr, "aim_enabled") => {
        $app.config_store
            .read()
            .get_bool($crate::app::config_system::keys::AIM_ENABLED)
            .unwrap_or(false)
    };
    ($app:expr, "aim_fov") => {
        $app.config_store
            .read()
            .get_float($crate::app::config_system::keys::AIM_FOV)
            .unwrap_or(5.0)
    };
    ($app:expr, "aim_smoothing") => {
        $app.config_store
            .read()
            .get_float($crate::app::config_system::keys::AIM_SMOOTHING)
            .unwrap_or(0.0)
    };
    ($app:expr, "accent_color") => {
        $app.config_store
            .read()
            .get_color($crate::app::config_system::keys::ACCENT_COLOR)
            .unwrap_or(egui::Color32::GREEN)
    };
    ($app:expr, "discord_presence") => {
        $app.config_store
            .read()
            .get_bool($crate::app::config_system::keys::DISCORD_PRESENCE)
            .unwrap_or(true)
    };
    ($app:expr, "streamproof") => {
        $app.config_store
            .read()
            .get_bool($crate::app::config_system::keys::STREAMPROOF)
            .unwrap_or(true)
    };
    ($app:expr, "enable_esp") => {
        $app.config_store
            .read()
            .get_bool($crate::app::config_system::keys::ENABLE_ESP)
            .unwrap_or(true)
    };
}
...
macro_rules! config_set {
    ($app:expr, "aim_enabled", $value:expr) => {
        $app.config_store
            .write()
            .set_bool($crate::app::config_system::keys::AIM_ENABLED, $value)
            .ok()
    };
    ($app:expr, "aim_fov", $value:expr) => {
        $app.config_store
            .write()
            .set_float($crate::app::config_system::keys::AIM_FOV, $value)
            .ok()
    };
    ($app:expr, "aim_smoothing", $value:expr) => {
        $app.config_store
            .write()
            .set_float($crate::app::config_system::keys::AIM_SMOOTHING, $value)
            .ok()
    };
    ($app:expr, "accent_color", $value:expr) => {
        $app.config_store
            .write()
            .set_color($crate::app::config_system::keys::ACCENT_COLOR, $value)
            .ok()
    };
    ($app:expr, "discord_presence", $value:expr) => {
        $app.config_store
            .write()
            .set_bool($crate::app::config_system::keys::DISCORD_PRESENCE, $value)
            .ok()
    };
    ($app:expr, "streamproof", $value:expr) => {
        $app.config_store
            .write()
            .set_bool($crate::app::config_system::keys::STREAMPROOF, $value)
            .ok()
    };
    ($app:expr, "enable_esp", $value:expr) => {
        $app.config_store
            .write()
            .set_bool($crate::app::config_system::keys::ENABLE_ESP, $value)
            .ok()
    };
}
